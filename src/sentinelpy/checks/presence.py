...
Deprecated: use ``evaluate_security_findings`` from ``sentinelpy.checks.quality``
(or ``sentinelpy.checks``). This module remains for 1.x import compatibility
...
def evaluate_presence_findings(
    ...
    *,
    ...
    warnings.warn(
        "evaluate_presence_findings is deprecated; use evaluate_security_findings.",
        DeprecationWarning,
        stacklevel=2,
    )
